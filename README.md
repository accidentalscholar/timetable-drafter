...
### Preparation
Before using this script, ensure you have meticulously completed the setup _Excel_ file. There are 12 sheets in this file (_for ease-of-use, a template Excel file has been provided in this repository_):
